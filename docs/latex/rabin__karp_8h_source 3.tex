...
\DoxyCodeLine{00095\ \ \ \ \ \ \ \ \ \ \ \ \ text\_hash\ =\ (base*(text\_hash\ -\/\ ((size\_t)text[i]*power\ \%\ modulus)\ +\ modulus)\ \%\ modulus\ +\ (\textcolor{keywordtype}{size\_t})text[i\ +\ pattern\_length])\ \%\ modulus;}
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00097\ \ \ \ \ \}}
\DoxyCodeLine{00098\ }
